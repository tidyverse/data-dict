...
* An **error** means the dictionary is invalid or there's a critical mismatch between the data and dictonary. Errors will cause a production pipeline to fail, and you must fix them immediately. 
